        ...
        return VStack(spacing: 2) {
            ...
            ZStack {
                ...
                RoundedRectangle(cornerRadius: 8)
                    .fill(hasData ? viewModel.getGradientColor(for: scoreValue) : Color.gray.opacity(0.2))
                ...
                if hasData {
                    Text("\(Int(scoreValue))")
                        ...
                        .foregroundStyle(scoreValue > 50 ? Color.white : Color.black)
                }
    ...
    private func dayCell(for date: Date) -> some View {
        ...
        return ZStack {
            ...
            RoundedRectangle(cornerRadius: 2)
                .fill(score != nil ? viewModel.getGradientColor(for: scoreValue) : Color.gray.opacity(0.2))
                .frame(width: cellSize, height: cellSize)
